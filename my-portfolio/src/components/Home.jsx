...
export default function Home() {
  return (
    <div
      id="home"
      className="flex flex-col items-center h-5/6 sm:min-h-screen text-center p-6 bg-slate-950 "
    >
      ...
      <Divmotion
        ...
        className="mt-10 w-23 h-23 sm:w-32 sm:h-32 md:w-36 md:h-36 flex items-center justify-center rounded-full 
      ...
      <H2motion
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: false, amount: 0.3 }}
        className="mt-3 text-2xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-3 
      ...
      <H3motion
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: false, amount: 0.3 }}
        className="text-lg sm:text-2xl font-normal text-gray-400 mt-4"
      >
      ...
      <Pmotion
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: false, amount: 0.3 }}
        className="text-gray-400 max-w-lg sm:max-w-2xl text-xs sm:text-lg mt-5 px-2"
      >
        Hi, I’m Afham Dunnur. A passionate developer exploring frontend and
        backend technologies. Let’s build something amazing together!
      </Pmotion>
