...
export default function ProjectCard() {
  ...
  return (
    <section id="project" className="space-y-10 p-6 bg-slate-950">
      ...
      >
        <h2
          className="text-3xl font-bold mb-3 bg-gradient-to-r from-amber-200 via-amber-300 to-amber-600 bg-clip-text text-transparent relative
      ...
      {projectsdata.map((val, id) => (
        ...
        >
          ...
          <div className="p-4 space-y-3">
            <h3 className="text-md sm:text-xl font-semibold text-gray-300">
              {val.title}
            </h3>
