...
const skills = [
  ...
  },
  {
    name: "Angular",
    level: 85,
    icon: <SiAngular size={40} className="text-amber-500" />,
  },
  {
    name: "MongoDB",
    level: 70,
    icon: <SiMongodb size={40} className="text-amber-500" />,
  },
  {
    name: "Node.js",
    level: 80,
    icon: <FaNodeJs size={40} className="text-amber-500" />,
  },
  {
    name: "Express",
    level: 85,
    icon: <SiExpress size={40} className="text-amber-500" />,
  },
  {
    name: "TypeScript",
    level: 70,
    icon: <SiTypescript size={40} className="text-amber-600" />,
  },
];
...
export default function Skill() {
  return (
    <div
      id="skill"
      className="min-h-screen bg-slate-950 flex flex-col items-center mt-0 py-12 px-4"
    >
      <H1vmotion
